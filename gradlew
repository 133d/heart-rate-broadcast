...
if "$cygwin" || "$msys" ; then
    ...
    for arg do
        ...
        # args, each time shifting the first arg to the position of the last
        # arg, so that positional args after $1 are shifted left.
...
#
# With -n://n://n://n://n://n it returns the last arg.
